...
tank_r = pygame.image.load("neo_tank.png")
tank_l = pygame.image.load("neo_tank2.png")
tank = tank_r
...
Hfont = pygame.font.Font("LCD.ttf",45)
...
while running:
        ...
        for column in range(len(level1[row])):
            if level1[row][column] == "2":
                if george_x >= column*32-58 and george_x <= column*32+6:
                    if up_key and input_cancel == 0:
                        v2 = -0.08
                    elif down_key and input_cancel == 0:
                        v2 = +0.08
                    else:
                        v2 = 0
    ...
    if hit_count1 == 5 and b1_height == 0:
        building1 = b1_d
        score += 100
    elif hit_count1 == 5 and b1_height == 1:
        building1 = b1_u
        score += 100
        
    if hit_count2 == 5 and b2_height == 0:
        building2 = b2_d
        score += 100
    elif hit_count2 == 5 and b2_height == 1:
        building2 = b2_u
        score += 100
        
    if hit_count3 == 5 and b3_height == 0:
        building3 = b3_d
        score += 100
    elif hit_count3 == 5 and b3_height == 1:
        building3 = b3_u
        score += 100
    ...
    HPmeter = Hfont.render(f"HP: {HP}", True, (85, 255, 51))
    HPmeterRect = HPmeter.get_rect()
    HPmeterRect.center = (100,30)
    screen.blit(HPmeter, HPmeterRect)
